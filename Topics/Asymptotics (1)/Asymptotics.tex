...
\item \begin{theorem}\label{asym.thm.holder.ineq} \textbf{H\"{o}lder} (Grimmett and Stirzaker p. p. 143, 319) Generalization of Cauchy-Schwarz. For \(p, q > 1\) satisfying \(1/p + 1/q =1\) we have
...
\begin{theorem}\label{asym.lln2} \textbf{Strong Law of Large Numbers (Grimmett and Stirzakker Theorem 7.5.1, 541A notes Theorem 2.11).} Let \(\{X_k\}\) be a sequence of (i) independent (ii) identically distributed random variables. Then if and only if (iii) \(\E|X_k|  < \infty \),
