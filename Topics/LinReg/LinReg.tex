...
\begin{theorem}[\textbf{Gauss-Markov Theorem, as stated in \citet{faraway2002}, more general case}]
...
\subsection{Quantile Regression}\label{linreg.sec.quant.reg}
...
\subsubsection{Detecting outliers in multiple dimensions}
...
\subsection{Transformed Linear Models}

\subsubsection{Transformations of response}
...
\subsubsection{Transforming predictor values}
...
\subsection{Segmented regression, local regression, splines}
...
\subsubsection{Curse of Dimensionality (brief discussion)}
...
\subsubsection{Dimension reduction by random matrix}
...
\subsection{Goodness of fit, residuals, residual diagnostics, leverage}
...
\[
 ...
 \begin{equation}\label{linreg.gsba.604.ridge.b}
...
\subsection{Loss Functions}\label{linreg.sec.loss.fxs}
...
\subsection{Generalized linear models}\label{linreg.glm}
