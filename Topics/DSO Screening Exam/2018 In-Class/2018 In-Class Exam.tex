...
\[
\E(X^TX) = \E[ \E(X^TX \mid \mu)] =  \E \left[ \E \left( X_1^2 + X_2^2 + \ldots + X_n^2 \right)  \right] = \E \left[ \sum_{i=1}^n \E (X_i^2)  \right] 
\]
...
\[
\implies \E(X^TX - n) =  \lVert \mu \rVert_2^2 
\]

Therefore \(\boxed{X^TX - n}\) is unbiased for \(\lVert \mu \rVert_2^2\).

% 3b
\item \textbf{Try using information here: section 3.4, page 62} \begin{verbatim}http://www.stat.cmu.edu/~brian/463-663/week09/Chapter%2003.pdf\end{verbatim} 
