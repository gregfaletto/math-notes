...
%Let \(u =  e^{\theta_1}/c  \iff   \implies du = \frac{e^{\theta_1}}{c} \ d \theta_1 \iff \frac{du}{u} = d \theta_1 \), so we can express this integral as

%\[
%=  c^{\lambda(m_1 - 1)}   \int_{0}^\infty\frac{u^{\lambda m_1}}{\left(1 + u \right)^\lambda}  \ \frac{du}{u} =  c^{\lambda(m_1 - 1)}   \int_{0}^\infty\frac{u^{\lambda m_1 - 1}}{\left(1 + u \right)^\lambda}  \ du
%\]
